...
app.factory('ProjectsFactory', function() {
	var projects = [
		...
		},
		{
			...
			customer: "Startup",
			description: "Im Rahmen eines Startupprojektes wurde eine Web-Appliaktion entwickelt, mit man das Veröffentlichen von Instagram Beiträgen automatisieren und verienfachen kann.",
			location: "Hamburg",
			language: "Deutsch",
			...
			technicalLanguages: [ "C#", "HTML", "CSS", "JavaScript", "SQL", "Razor" ],
		...
		},
		{
			...
			typeOfSoftware: "Web",
			link: "http://www.hamburg-startups.net/comate-me-die-geburt-eines-startups/",
	...
	for(var f in projects) {
		var project = projects[f];
		
		var end = project.end || new Date();
		
		project.months = Math.round(Math.abs(end - project.start) / (1000 * 60 * 60 * 24 * 30)) + 1;
	}
